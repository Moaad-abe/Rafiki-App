...
export class AppComponent {
  ...
  constructor(private snackBar: MatSnackBar ,
              private ngsw: SwUpdate , public auth: AuthService) {
  ...
  updateNetworkStatusUI() {
    if (navigator.onLine) {
      // You might be online
      (document.querySelector('.container') as any).style = '';
    } else {
      // 100% Sure you are offline
      (document.querySelector('.container') as any).style = 'filter: grayscale(1)';
    }
  }
